...
export function About() {
  ...
  return (
    <section id="about" className="container py-20 md:py-32 relative min-h-screen flex flex-col">
      {/* Декоративный фон */}
      <div className="absolute inset-0 bg-gradient-to-br from-accent/5 via-transparent to-secondary/5 pointer-events-none" />
      
      <div ref={ref} className="grid gap-12 md:grid-cols-2 items-center relative z-10 flex-1 justify-center">
        {/* Левая колонка - Текст */}
        <motion.div
        ...
        >
          ...
          <div className="relative h-full rounded-lg overflow-hidden">
            {/* Фоновое изображение комнаты с размытием, выровнено по правому краю */}
            ...
            {/* Изображение девушки поверх фона, выровнено по нижнему краю */}
