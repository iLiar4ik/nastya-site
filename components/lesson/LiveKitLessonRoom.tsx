      ...
      {excalidrawUrl ? (
          ...
          <div className="px-3 py-1.5 border-b bg-muted/50 text-sm font-medium shrink-0 flex flex-col gap-0.5">
            ...
            {excalidrawRoomWsUrl && (
              <div className="text-xs font-normal text-muted-foreground">
                Сервер комнат: <code className="bg-muted/80 px-1 rounded">{excalidrawRoomWsUrl}</code>
              </div>
            )}
          </div>
        ...
        <section className="flex-1 min-h-[280px] flex flex-col rounded-lg border border-dashed bg-muted/20 items-center justify-center p-4">
          <p className="text-sm text-muted-foreground text-center">
            Задайте <code className="text-xs bg-muted px-1 rounded">NEXT_PUBLIC_EXCALIDRAW_URL</code> в Environment (например https://excalidraw.math-nastya.ru).
          </p>
        </section>
      )}
